# AGENTS.md: Guidelines for `modules/features/library/dusty-devotional`

## Purpose
This capsule defines the Dusty Devotional profile manual and its content registration for Veritas.

## Allowed Paths
- `modules/features/library/dusty-devotional/**`

## Non-Negotiables
- **Scope:** Only edit files under `modules/features/library/dusty-devotional`.

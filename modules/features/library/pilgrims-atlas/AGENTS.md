# AGENTS.md: Guidelines for `modules/features/library/pilgrims-atlas`

## Purpose
This capsule defines the Pilgrim's Atlas feature and its content registrations. It must remain isolated and data-focused.

## Allowed Paths
- `modules/features/library/pilgrims-atlas/**`

## Non-Negotiables
- **Scope:** Only edit files under `modules/features/library/pilgrims-atlas`.

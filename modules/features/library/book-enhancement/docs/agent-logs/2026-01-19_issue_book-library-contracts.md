...
status: resolved
owner: codex
capsule: library/book-enhancement
...
## Context
Book Enhancement targets library-backed books with large offline content. Current BookDef wiring only supports vanilla written book content limits.
...
- Library loader uses Book Enhancement pagination and classpath resources.
